...
CONCEPT_HINTS = {
    ...
    "tool calls": "concepts/Tool_Calling",
    "tool call": "concepts/Tool_Calling",
    "hallucination detection": "concepts/Hallucination",
    "ced": "concepts/Causal_Encoder_Decoder",
    "encoder-decoder architecture": "concepts/Causal_Encoder_Decoder",
    "quantization precision": "concepts/Quantization",
